...
class Agent(object):
    ...
    def __init__(self, state_space, action_space, alpha=0.05, epsilon=0.05, gamma=0.95, q_init = 0.):
    ...
    def act(self, observation):
        ...
        if np.random.random() > self.epsilon and np.max(self.q_values[observation]) > self.q_init: # Explore
